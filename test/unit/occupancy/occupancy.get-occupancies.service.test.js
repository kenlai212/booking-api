...
describe('Test occupancy.service', () => {
    describe("testing getOccupancies", function () {
        input = {};
        user = {};
        ...
        it("occupancy.find() db error, should return 500", async () => {
            ...
            Occupancy.find = await jest.fn().mockRejectedValue(new Error("occupancy.find db error"));
            ...
            return expect(occupancyService.getOccupancies(input, user)).rejects.toEqual({
                status: 500,
                message: "occupancy.find db error"
            });
